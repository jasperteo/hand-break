...
export default function RootRoute() {
  return (
    <div className="grid min-h-screen grid-rows-[20px_1fr_20px] place-items-center gap-16 p-8 pb-20 sm:p-20">
      <main className="row-start-2 flex flex-col items-center gap-8 sm:items-start">
        ...
        <ol className="list-inside list-decimal text-center font-mono text-sm sm:text-left">
          <li className="mb-2">
            ...
            <code className="rounded bg-black/[.05] py-0.5 px-1 font-semibold dark:bg-white/[.06]">
              src/app/page.tsx
            </code>
          </li>
        ...
        <ButtonLink href="/newpage">Click Me</ButtonLink>
